...
export function BackToTopAndChat() {
  ...
  return (
    <div className="fixed bottom-4 right-0 z-50 flex max-w-max flex-col items-center justify-center font-urbanist md:justify-between">
      {/* <p
        style={{
      ...
      <BackToTop
        onClick={scrollToTop}
        className={`mt-3 cursor-pointer ${backToTopClassName}`}
      />
    </div>
  )
}
