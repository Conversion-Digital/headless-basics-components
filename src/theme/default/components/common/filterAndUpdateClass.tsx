...
export function filterAndUpdateTags(html: string, languageSite: LanguageSite) {
  ...
  for (let i = 1; i <= 5; i++) {
    if (i == 2) {
      $(`h${i}`).addClass(
        `text-center text-my-brown-grey font-urbanist font-800 text-3xl leading-12 md:text-h3 md:leading-h3 mb-14`
      )
    } else {
...
export function formatHeading(heading: string | AnyNode | AnyNode[]) {
