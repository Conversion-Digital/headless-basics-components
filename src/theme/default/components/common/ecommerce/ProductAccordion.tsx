    ...
    <Accordion className="AccordionRoot" type="multiple">
      {!product?.turnOnAdvancedProductSpecificationTable &&
        ...
        product?.specifications.length > 0 && (
          <AccordionItem
            className="AccordionItem border-t border-my-blue pr-1 last:mb-20 md:last:mb-28"
      ...
      {product?.turnOnAdvancedProductSpecificationTable &&
        ...
        product?.rows.length > 0 && (
          ...
          >
            ...
            <AccordionContent>
              <AdvancedSpecificationTable data={{ ...product, rows: product.rows || [] }} />
            </AccordionContent>
          </AccordionItem>
        )}
      {product?.imageSectionContent && (
        <AccordionItem
          className="AccordionItem border-my-blue pr-1 last:mb-20 md:last:mb-28"
          ...
          <AccordionContent>
            ...
            <div className="grid grid-cols-1 justify-items-center gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-10">
              {product?.imageSectionContent?.slice(1).map((content, index) => (
                ...
                >
                  <Image
                    className="mx-auto mb-4 h-58 w-full max-w-236 object-cover"
                    alt={
