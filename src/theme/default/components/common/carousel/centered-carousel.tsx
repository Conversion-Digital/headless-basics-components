...
const Slide = ({ imgSrc, isLeftSlide, isRightSlide, isDragging, altText }: SlideProps) => {
  return (
    <div
      ...
      <Slider {...settings} ref={sliderRef}>
        {slides?.map((slide, index) => (
          <Slide
            ...
            imgSrc={slide.url}
            altText={
              slide?.media?.altText && slide?.media?.altText !== ""
                ? slide?.media?.altText
                : slide?.media?.name && slide?.media?.name !== ""
                ? slide?.media?.name
                : slide?.name || "default alt text"
            }
