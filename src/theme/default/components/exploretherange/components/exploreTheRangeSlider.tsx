...
interface ExploreTheRangeComponentSliderProps {
  children: React.ReactNode;
}

export default function ExploreTheRangeComponentSlider({children}: ExploreTheRangeComponentSliderProps) {
  ...
  const CustomPrevArrow = (props: { onClick: React.MouseEventHandler<HTMLButtonElement> | undefined }) => (
    <button
  ...
  const CustomNextArrow = (props: { onClick: React.MouseEventHandler<HTMLButtonElement> | undefined }) => (
    <button
