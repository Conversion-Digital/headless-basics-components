...
export const log = getLogger("conversion.components.sanity.cdcta.mapping");
...
export async function mapIdentifierData(pageAndComponentCombo: PageAndSingleComponentDetails) {
  ...
  // The second arg 'cdcta' must match the name in cdcta's sanity-schema
  const matchingData = extractComponentsFromSanityData(content, "cdcta", log);
