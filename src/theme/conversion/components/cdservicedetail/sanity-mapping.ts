...
export const log = getLogger("conversion.components.sanity.cdservicedetail.mapping")
...
export async function mapIdentifierData(pageAndComponentCombo: PageAndSingleComponentDetails) {
  ...
  const matchingData = extractComponentsFromSanityData(content, "cdservicedetail", log, true, '', thisComponentsOrder);
  return matchingData
}
