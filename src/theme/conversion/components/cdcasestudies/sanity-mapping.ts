...
export const log = getLogger("conversion.components.sanity.cdcasestudies.mapping");
...
export async function mapIdentifierData(pageAndComponentCombo: PageAndSingleComponentDetails) {
  ...
  const matchingData = extractComponentsFromSanityData(content, "cdcasestudies", log);
