...
export const log = getLogger("conversion.components.sanity.cdintroduction.mapping")
...
export async function mapIdentifierData(pageAndComponentCombo: PageAndSingleComponentDetails) {
  ...
  const matchingData = extractComponentsFromSanityData(content, "cdintroduction", log);
