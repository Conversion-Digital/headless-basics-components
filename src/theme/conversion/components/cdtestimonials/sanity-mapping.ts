...
export const log = getLogger("conversion.components.sanity.cdtestimonials.mapping");
...
export async function mapIdentifierData(pageAndComponentCombo: PageAndSingleComponentDetails) {
  ...
  const matchingData = extractComponentsFromSanityData(content, "cdtestimonials", log);
  return matchingData;
}