...
const componentName = 'frame469_demo_page'
          ...
          components: [
            {
              ...
              _key: componentDocId,
              _type: 'frame469',
              selectableVariant: demoVariantData.variant || "demo",
              sortOrder: demoVariantData.sortOrder || 99,
              title: demoVariantData.title,
              subtitle: demoVariantData.subtitle,
              phone: demoVariantData.phone,
              fax: demoVariantData.fax,
              email: demoVariantData.email,
              officeLocation: demoVariantData.officeLocation,
              bookButtonLabel: demoVariantData.bookButtonLabel,
              bookButtonLink: demoVariantData.bookButtonLink
            },
          ],
        },
      },
