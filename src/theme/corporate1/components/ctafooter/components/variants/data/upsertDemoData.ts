          ...
          components: [
            {
              ...
              description: demoVariantData.description,
              email: demoVariantData.email,
              phone: demoVariantData.phone,
              address: demoVariantData.address,
              ctaLabel: demoVariantData.ctaLabel,
              ctaLink: demoVariantData.ctaLink,
              sortOrder: 0
            },
          ],
        },
